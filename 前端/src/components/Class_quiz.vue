<template>
    <div>
        ...
        <!--选择完毕，测试界面-->
        <div v-else>
            <mt-field label="" placeholder="题目加载中..." type="textarea" rows="4" v-model="item[2]"
...
<script>
    ...
    export default{
        computed: {
            ...
            item_type: function () {
//                 将item_type初始化为与所有题型不同的字符串，这样
//                 才会激活watch，使得item_answer根据type初始化
        ...
        methods: {
            ...
            nextItem (){
                ...
                if (this.end_flag == true) {
                    ...
                    this.item_answer = this.item_answer.slice(0, 0)
